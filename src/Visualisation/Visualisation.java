...
public class Visualisation extends Application {
    ...
    public static List<JernCluster> clusters;
    ...
    public static void run(Solution solution_input, List<JernCluster> clusters_input, List<Depot> depots_input) {
        solution = solution_input;
        clusters = clusters_input;
        depots = depots_input;

        for(JernCluster c: clusters){
